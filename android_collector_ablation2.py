...
@timer
def android_sim_traj_ablation2(init_state: str,
                      guide, 
    ...
    print("####Ablation 2####")
    simulator = AblationAndroidSimulator()
    ...
    if save:
        ...
        # print("############")
        directory = f'train_set_android_ablation2/init_state_{index}_maxlen={max_step}/iter_{num}'
                ...
                for i, post_reasoning_task in enumerate(post_reasoning_tasks):
                    ...
                    if 'None' not in answer:
                        ...
                        if save:
                            ...
                            directory = f'train_set_android_ablation2/init_state_{index}_maxlen={max_step}/iter_{num}_reasoning_{i}'
                            os.makedirs(directory, exist_ok=True)
...
############################################
def process_sim_collect_ablation2(init_state, guides, num_guides_per_step, min_step=3, max_step=5, index=1, save=True, rag_enabled=False):
    # print(guides)
...
def collect_ablation2(init_states, num_guides_per_step, min_length_range: list, nums: list, debug=False, rag_enabled=True):
    ...
    if debug:
        ...
        for i in range(nums[0]):
            android_sim_traj_ablation2(init_states[0], guide, num_guides_per_step, min_step=min_step, max_step=min_step+6, index=1000, num=i, save=True, rag_enabled=rag_enabled)
...
if __name__ == '__main__':
    ...
    # debug
    collect_ablation2(init_states, args.num_guides_per_step, args.min_steps, args.nums, debug=args.debug, rag_enabled=args.rag_enabled)